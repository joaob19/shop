...
import 'package:shop/models/user_data.dart';
...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlFragment?key=AIzaSyD4y_zSdQlsO4foGV-U9kcAQmHwckrIJM4';
  ...
  Future<void> tryAutoLogin() async {
    ...
    final userDataMap = await Store.getMap('userData');
    if (userDataMap.isEmpty) return;
